...
# Function for initiating the alert sound
def alert_sound():
    pygame.mixer.init()
...
''' When using the IP webcam the parameter in cv2.VideoCapture() should be set to the    'url'   '''
camera = cv2.VideoCapture(0)

# Defining the path for the 68 face landmarks detector
predictor_path = ("predictor/shape_predictor_68_face_landmarks.dat_2")
